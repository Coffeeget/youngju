...
<?php
    ...
    $logged = $username."님 [level:".$userlevel.", Ponit:".$userpoint."]";
?>
    <li><?= $logged ?></li>
    <li> | </li>
    ...
    <section id="sub_section">
        ...
        <div id="sub_section_main">
            ...
            <div class="sub_section_middle">
                ...
                <div id="membership">
                    <figure><img src="./images/slide_btn1.png" alt="youngju"></figure>
                    <div class="membership">
                        <form action="member_insert.php" method="post" name="member_form">
                            ...
                            <input type="text" name="id">
                                ...
                                <div class="col3">
                                <a href="#"><img src="./images/check_id.gif" alt="중복확인" onClick="check_id()" style="margin-top:10px"></a>
                                </div>
                            </div>
                            <div class="form">
                    ...
                    <div class="btnBox">
                        ...
                        <button id="reset_button" onClick="reset_form()">취소하기</button>
                    </div>
                </div>
                <div class="tel">
                    <table>
