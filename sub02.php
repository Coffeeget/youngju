    ...
    <section id="sub_section">
                ...
                <div class="sub_sectionTop_c">
                    ...
                    <div>
                        <ul>
                            ...
                            <li><a href="#none">영주소개</a></li>
                            <li><a href="#none">영주의 상징</a></li>
                            <li><a href="#none">시조/시목/시화</a></li>
                        </ul>
                    </div>
                </div>
        ...
        <div id="sub_section_main">
            <div class="sub_section_side">
                <ul>
                    <li>
                        <a href="#none" class="click">영주의 상징</a>
                        <ul class="down">
                            <li><a href="#none">시조/시목/시화</a></li>
                            <li><a href="#none">영주 C I</a></li>
                            <li><a href="#none">시민의 노래</a></li>
                            <li><a href="#none">시민현장</a></li>
                            <li><a href="#none">영주시 캐릭터</a></li>
                        </ul>
                    </li>
                    <li>
                        <a href="#none" class="click">시청안내</a>
                        <ul class="down">
                            <li><a href="#none">행정조직도</a></li>
                            <li><a href="#none">시청사소개</a></li>
                            <li><a href="#none">행정구역/인구/가구</a></li>
                    ...
                    <li>
                        <a href="#none" class="click">영주의 역사</a>
                        <ul class="down">
                            <li><a href="#none">역사·특성</a></li>
                            <li><a href="#none">선비정신실천</a></li>
                            <li><a href="#none">역대 시장 군수</a></li>
            ...
            <div class="sub_section_middle">
                <div class="sub02_cont_top">
                    <img src="./images_sub/sub2_top.jpg" width="1000" height="360" alt="sub2_top">
                </div>
                <div class="sub02_cont">
                    <div class="sub02_content">
                        <div class="sub02_cont1 sub02_box">
                            <h2>시조 - <span>까치</span></h2>
                            <img src="./images_sub/sub02_cont1.gif" alt="sub02_cont1">
                            <p>원산지 : 한국</p>
                            <p>특징 : 옛부터 기쁜 소식을 예고하는 길조로 알려졌으며 밝은 미래를 나타냅니다.</p>
                        </div>
                        <div class="sub02_cont2 sub02_box">
                            <h2>시목 - <span>은행나무</span></h2>
                            <img src="./images_sub/sub02_cont2.gif" alt="sub02_cont2">
                            <p>분포지 : 한국,중국,일본</p>
                            <p>특징 : 수명이 길고 많은 열매를 맺는 나무로서 지역의 번성과 발전을 기원합니다.</p>
                        </div>
                        <div class="sub02_cont3 sub02_box">
                            <h2>시화 - <span>철쭉</span></h2>
                            <img src="./images_sub/sub02_cont3.gif" alt="sub02_cont3">
                            <p>원산지 : 한국</p>
                            <p>특징 : 그윽한 향기와 은은한 매력을 발산하는 꽃으로 시민의 따뜻한 정감을 나타냅니다.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="sub_section_bottom_side">
                <h2>페이지 담당자<span>기획예산실 박인경( 054-639-6022 )</span><span>페이지 수정일: 2023-04-19</span></h2>
                <div>
