...
<script>
	...
	//글쓰기 폼 양식 하단의 <완료> 버튼([그림 14-3]) 클릭하면 호출되는 check_input( ) 함수 정의.
	//사용자가 입력 창에 내용을 입력했는지 검사.
	//이상이 없으면 ②의 action에 설정한 board_insert.php로 이동.
...
?>
    ...
    <section id="sub_section">
		...
		<!-- <form> 태그의 name 속성 값인 board_form은 ①의 check_input( ) 함수에서 사용.
		...
		<form  name="board_form" method="post" action="board_insert.php" enctype="multipart/form-data">
			<ul id="board_form">
				...
				<li>
				<!-- 글 제목 설정 :
				글쓰기 폼 양식에서 제목 입력 창의 name 속성을 subject로 설정.
				사용자가 입력한 제목이 POST 방식인 $_POST[“subject”]로 board_insert.php에 전달됨.
				 -->
					<span class="col1">제목  </span>
					<span class="col2"><input name="subject" type="text" placeholder="제목을 입력하세요"></span>
				...
				<!--글 내용 설정 :
				사용자가 입력한 글 내용이 $_POST[“content”]로 board_insert.php에 전달.
				  -->
				...
				name 속성 값인 upfile은 첨부 파일을 서버에 업로드할 때 사용됨.
				 -->
			...
			<ul class="buttons">
				...
				<li><button type="button" onclick="location.href='sub03.php'">목록</button></li>
			</ul>
		</form>
	</div> <!-- board_box -->
