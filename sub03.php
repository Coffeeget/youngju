    ...
    <section id="sub_section">
        ...
        <div id="sub_section_main">
            ...
            <div class="sub_section_middle">
                <div id="sub03_pop">
                    <div class="sub03_pop">
                        <span class="pop_img"><i class="fas fa-exclamation-circle"></i></span>
                        <div>
                            <h2>시민이 참여하여 만드는 자유게시판 페이지입니다.</h2>
                            <p>자유게시판은 답변을 하지 않으며, 답변을 원하시는 사항은 전자민원신청을 이용하시기 바라며, 정치적 목적의 성향이 있는 내용, 불건전환 어휘, 비방, 광고,
                                욕설, 음란, 개인정보, 언론보도 내용, 스크랩이나 단순한 사이트로 링크 등이 포함된 글은 게시할 수 없습니다. </p>
                            <button>전자민원신청 바로가기</button>
                            <p>
                                <i class="fas fa-star"></i>
                                "자유게시판" 운영목적과 관련 없는 내용은 영주시 인터넷시스템 설치 및 운영에 관한 조례 제6조에 의거 삭제되며, 불법유해정보를 게시하거나 배포하면
                                정보통신망이용촉진 및 정보보호 등에 관한 법률에 따라 벌칙(징역 또는 벌금)을 받을 수 있습니다.
                            </p>
                            <p>- 특히 정치적 목적의 성향이 있는 내용, 특정인 비방, 음란물 , 광고, 유사 또는 반복 게시물 글은 사전 통보없이 삭제됨을 양지하여 주시기 바랍니다.</p>
                            <p>글 등록시 제목이나 게시내용, 첨부파일 등에 개인정보(주민등록번호, 사업자등록번호, 통장계좌번호 등)는 차단되어 게시되지 않으니 확인하여 주시기 바랍니다.
                            </p>
                            <p style="color: red;">
                                <i class="fas fa-star"></i>
                                <strong>광고, 구인구직 등 홍보성 글은 "홍보(광고)마당" 게시판을 이용하여 주시기 바랍니다.</strong>
                            </p>
                            <p><span>게시글 삭제기준을 알려드립니다. -영주시 인터넷시스템 설치 및 운영에 관한 조례 (2020. 06. 22 조례 제1280호)</span></p>
                            <span>1. 국가안전이나 보안에 위배되는 경우</span>
                            <span>2. 정치적 목적이나 성향이 있는 경우</span>
                            <span>3. 특정기관, 단체, 부서를 근거 없이 비난하는 경우</span>
                            <span>4. 특정인을 비방하거나 명예훼손의 우려가 있는 경우</span>
                            <span>5. 영리목적의 상업성 광고, 저작권을 침해할 수 있는 내용</span>
                            <span>6. 욕설, 음란물 등 불건전한 내용</span>
                            <span>7. 실명을 원칙으로 하는 경우에 실명을 사용하지 않았거나 실명이 아닌 것으로 판단 되었을 경우</span>
                            <span>8. 동일인 또는 동일인이라고 인정되는 사람이 똑같은 내용을 주 2회 이상 게시하거나 비슷한 내용을 1일 2회이상 게시하는
                                경우<br>&nbsp;&nbsp; (개정
                                2015.11.25)</span>
                            <span>9. 그 밖에 연습성, 오류, 장난성 같은 내용의 글 등 해당 게시판의 취지와 부합하지 않을 경우 등(개정 2015.11.25)</span>
                        </div>
                        <button class="pop_closed">닫기</button>
                    </div>
                </div>
...
?>
        <tr>
            ...
            <td class="col2"><a href="board_view.php?num=<?=$num?>&page=<?=$page?>"><?=$subject?></a></td>
